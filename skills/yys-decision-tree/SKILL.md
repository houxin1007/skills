...
- 最内层（我方第五手）加横向条形图
- 每层对方第四手下方加一行**对方五选**：对方第五手式神名称+出现次数，按次数降序排，最多10个
...
对方第四手例外：对方四手胜率低于40%仍保留展示，标记“劣势”（半透明+劣势字样），最低场次20场。对方四手的劣势选项是关键信息（说明我方上这个式神时，对方反手这个式神我方容易输），必须展示。对方四手在页面分两组展示：先“优势组”（我胜率≥40%），再以分隔线显示“劣势组（我胜率<40%，含补位）”；劣势组内真实劣势（胜率<40%且场次≥20）标[劣势]，补位项标[补]（低样本劣势即场次<20但胜率<40%的补位项同时标[劣势][补]）。
...
- 我方4手/5手：不足5种按胜率≥40%场次最多的补；对方4手：优势组与劣势组各保5种（劣势组补入只看场次、不重复优势组）
- 对方4手页面结构：优势组 + 分隔线"对方·劣势（我胜率<40%，含补位）" + 劣势组；真实劣势标[劣势]，补位标[补]
﻿